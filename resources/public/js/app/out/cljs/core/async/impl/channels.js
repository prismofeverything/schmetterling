...
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t6783 !== 'undefined')
{} else
{goog.provide('cljs.core.async.impl.channels.t6783');

/**
* @constructor
*/
cljs.core.async.impl.channels.t6783 = (function (val,box,meta6784){
this.val = val;
this.box = box;
this.meta6784 = meta6784;
this.cljs$lang$protocol_mask$partition1$ = 0;
this.cljs$lang$protocol_mask$partition0$ = 425984;
})
cljs.core.async.impl.channels.t6783.cljs$lang$type = true;
cljs.core.async.impl.channels.t6783.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t6783";
cljs.core.async.impl.channels.t6783.cljs$lang$ctorPrWriter = (function (this__3410__auto__,writer__3411__auto__,opt__3412__auto__){return cljs.core._write.call(null,writer__3411__auto__,"cljs.core.async.impl.channels/t6783");
});
cljs.core.async.impl.channels.t6783.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
return self__.val;
});
cljs.core.async.impl.channels.t6783.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_6785){var self__ = this;
return self__.meta6784;
});
cljs.core.async.impl.channels.t6783.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_6785,meta6784__$1){var self__ = this;
return (new cljs.core.async.impl.channels.t6783(self__.val,self__.box,meta6784__$1));
});
cljs.core.async.impl.channels.__GT_t6783 = (function __GT_t6783(val__$1,box__$1,meta6784){return (new cljs.core.async.impl.channels.t6783(val__$1,box__$1,meta6784));
});
}
return (new cljs.core.async.impl.channels.t6783(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__3413__auto__,writer__3414__auto__,opts__3415__auto__){return cljs.core._write.call(null,writer__3414__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__3410__auto__,writer__3411__auto__,opt__3412__auto__){return cljs.core._write.call(null,writer__3411__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_6786 = self__.takes.pop();if((taker_6786 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_6786))
{var take_cb_6787 = cljs.core.async.impl.protocols.commit.call(null,taker_6786);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_6787,taker_6786){
return (function (){return take_cb_6787.call(null,null);
});})(take_cb_6787,taker_6786))
);
} else
{}
{
