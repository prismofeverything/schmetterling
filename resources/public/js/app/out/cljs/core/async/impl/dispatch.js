...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_6777 = 0;while(true){
var m_6778 = cljs.core.async.impl.dispatch.tasks.pop();if((m_6778 == null))
{} else
{m_6778.call(null);
if((count_6777 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__6779 = (count_6777 + 1);
count_6777 = G__6779;
continue;
}
} else
