...
{{
var G__5518 = cljs.core.pop.call(null,v__$1);
v__$1 = G__5518;
continue;
}
} else
...
{var pred__5522 = cljs.core._EQ_;var expr__5523 = limit;if(pred__5522.call(null,1,expr__5523))
{return cljs.core.vector.call(null,s);
} else
{if(pred__5522.call(null,2,expr__5523))
{return cljs.core.vector.call(null,"",s);
} else
...
var G__5525 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__5526 = (limit__$1 - 1);
var G__5527 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__5525;
limit__$1 = G__5526;
parts = G__5527;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___5529 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___5529))
{var replacement_5530 = temp__4090__auto___5529;buffer.append([cljs.core.str(replacement_5530)].join(''));
} else
{buffer.append(ch);
}
{
